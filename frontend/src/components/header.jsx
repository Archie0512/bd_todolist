 ...
 * @param {Function} props.onLoginLogout
 */
export function Header(props) {
  ...
  return (
    <header class="app-header">
      ...
      <button
        type="button"
        onClick={props.onLoginLogout}
        class={props.isAdmin ? "button--active" : ""}
      >
        {props.isAdmin ? props.t()('header.logout') : props.t()('header.login')}
      </button>
      <div class="app-header__group-item">
