export default {
	...
	header: {
		...
		newLane: "New lane", selectCards: "Select cards", exitSelection: "Exit selection", export: "Export", login: "Login", logout: "Logout", locale: "Language",
	},
	card: { due: "Due {{date}}", complete: "Mark complete" },
	...
	expandedCard: {
		addTag: "Tags", changeColor: "Change color", deleteTag: "Delete tag", dueDate: "Due date", newTagPlaceholder: "Enter new tag name...",
